---
name: clean-fd
description: Build clean, readable frontend interfaces by splitting pages into multiple focused components for better readability and abstraction. Use this skill when the user asks for frontend pages, screens, or UIs — especially when they say "clean code", "readable", "component-based", "split into components", or when designing any full page or screen. Always splits output into screen-level and reusable components. Always uses pre-existing UI libraries instead of writing UI from scratch. Use this instead of (or alongside) the frontend-design skill when code structure and maintainability matter.
---
